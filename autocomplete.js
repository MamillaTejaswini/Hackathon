...
{ name: 'The Bahamas', capital: 'Nassau' },
...
{ name: 'Monaco', capital: 'Monte Carlo' },
...
function display(result) {
    const content = result.map((country) => {
        return "<li onClick=selectInput(this)>" + country.name + " - " + country.capital + "</li>";
    });
    resultsBox.innerHTML = "<ul>" + content.join('') + "</ul>";
}

function selectInput(list) {
    inputBox.value = list.innerHTML.split(' - ')[0]; // Only set country name in the input
    resultsBox.innerHTML = '';
}
